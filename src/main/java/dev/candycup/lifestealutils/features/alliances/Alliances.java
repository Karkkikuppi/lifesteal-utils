...
public final class Alliances {
   ...
   public static List<String> getAllianceDisplayNames() {
   ...
   public static boolean addAlliance(Player player) {
      ...
      if (added) {
         cachePlayerName(uuid, player.getName());
         playAllianceSound();
      }
      return added;
   }
   ...
   public static boolean isAllied(Player player) {
      if (player == null) {
         return false;
      }
   ...
   private static void cachePlayerName(UUID uuid, Component nameComponent) {
      if (uuid == null || nameComponent == null) {
         return;
      }
   ...
   private static String applyColorToLastWord(String miniMessage) {
      ...
      if (start >= mapping.visibleToRaw().size() || end >= mapping.visibleToRaw().size()) {
         return miniMessage;
      }
