...
/**
 * Registers the managed Bulwark cooldown timer.
 */
public final class BulwarkCooldownTracker {
   ...
   public static final String DEFAULT_FORMAT = "<green><bold>Bulwark:</bold></green><white> {{cooldown}}</white>";

   private static final String CHAT_TRIGGER = "You activated Bulwark's ability";
