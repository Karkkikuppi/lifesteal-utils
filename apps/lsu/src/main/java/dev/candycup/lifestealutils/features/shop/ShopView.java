...
public sealed interface ShopView permits ShopView.Categories, ShopView.Listings, ShopView.SelectAmount {
    ...
    record Listings(String title, String categoryName, List<ListingRow> listings,
                    NavButtons navButtons) implements ShopView {
    }

    record SelectAmount(String title, String categoryName, String selectedItemName, List<ListingRow> previousListings,
                        List<BuyAmount> amounts, int goBackSlot) implements ShopView {
    }
